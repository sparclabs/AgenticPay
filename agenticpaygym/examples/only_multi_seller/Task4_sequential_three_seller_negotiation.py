"""Task4 Sequential Three-Seller Negotiation Example

Demonstrates how to use the Task4SequentialThreeSellerNegotiation to negotiate sequentially with three sellers,
...
def main():
    ...
    model = CustomLLM(api_key=api_key, model="qwen3-14b") # claude-sonnet-4-5-20250929, gpt-5.2, gemini-3-pro-all, gpt-3.5-turbo, DeepSeek-R1
    ...
    env = Task4SequentialThreeSellerNegotiation(
        buyer_agent=buyer,
    ...
    # Reset environment
    print("\n" + "="*60)
    print("Starting new sequential negotiation with three sellers...")
    print("="*60)
    ...
    results = {
        "task": "Task4_sequential_three_seller_negotiation",
    ...
    while not done:
        ...
        buyer_response = buyer.respond(
            ...
            current_state={
                **observation,
                "instruction": "You are negotiating with three sellers. Each round, you need to choose ONE seller to negotiate with and provide your negotiation message. Please clearly indicate which seller (1, 2, or 3) you want to negotiate with, for example: 'I want to negotiate with seller 1' or 'Let me talk to seller 2' or 'I'll negotiate with seller 3'."
            }
        )
        ...
        if selected_seller == 1:
            ...
            conversation_history = observation["conversation_history_seller3"].copy()
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task4: Sequential Three-Seller Negotiation Results\n")
            f.write("="*80 + "\n\n")
