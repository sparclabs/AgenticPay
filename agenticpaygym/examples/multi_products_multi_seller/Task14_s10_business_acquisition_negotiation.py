"""Task14 Scenario 10: Business Acquisition - Sequential Two-Seller Per One Product Negotiation

Buyer negotiating with two business brokers offering different small businesses.
...
def main(model_name=None):
    ...
    buyer_max_price = 520000.0  # Maximum acceptable price for buyer (confidential) - investor budget
    seller1_min_price = 380000.0  # Minimum acceptable price for seller1 (confidential) - established business owner
    seller2_min_price = 360000.0  # Minimum acceptable price for seller2 (confidential, lower due to growth stage)
    ...
    env = Task3SequentialTwoSellerPerOneProductNegotiation(
        ...
        initial_seller1_price=480000.0,  # Initial price offered by seller1
        initial_seller2_price=450000.0,  # Initial price offered by seller2 (lower due to growth risk)
        ...
        environment_info={
            ...
            "financing_contingency": "possible",
        },
        price_tolerance=0,
    ...
    user_profile = "Serial entrepreneur looking to acquire established business. Risk-averse, values transparent financials and smooth transition. Prefers owner financing options."
    print(f"User Profile: {user_profile}")
    
    # Get user requirement
    # Use default requirement for automatic running
    user_requirement = "Looking for profitable small business with steady cash flow. Prefer established customer base."
    print(f"Using default requirement: {user_requirement}")
    
    # Reset environment with different products for each seller
    print("\n" + "="*60)
    print("Starting new sequential negotiation with two business brokers (each with different businesses)...")
    print("="*60)
    
    observation, info = env.reset(
        user_requirement=user_requirement,
        seller1_product_info={
            "name": "Established Local Coffee Shop",
            "business_type": "Food & Beverage",
            "annual_revenue": "$420,000",
            "annual_profit": "$95,000",
            "years_operating": 8,
            "employees": 6,
            "lease_terms": "3 years remaining, favorable",
            "reason_for_sale": "Owner retiring",
            "financing_options": "50% owner financing available",
            "transition_support": "3 months",
        },
        seller2_product_info={
            "name": "Growing Digital Marketing Agency",
            "business_type": "Professional Services",
            "annual_revenue": "$380,000",
            "annual_profit": "$88,000",
            "years_operating": 4,
            "employees": 3,
            "lease_terms": "Remote, no physical lease",
            "reason_for_sale": "Founder pursuing other venture",
            "financing_options": "30% owner financing available",
            "transition_support": "2 months",
        },
    ...
    results = {
        "task": "Task14_s10_business_acquisition_negotiation",
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task14 Scenario 10: Business Acquisition - Sequential Two-Seller Per One Product Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task14 Scenario 10: Business Acquisition - Sequential Two-Seller Per One Product Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
