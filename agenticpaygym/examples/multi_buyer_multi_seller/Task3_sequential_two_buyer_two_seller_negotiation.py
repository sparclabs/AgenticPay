"""Task3 Sequential Two-Buyer Two-Seller Negotiation Example

Demonstrates how to use the Task3SequentialTwoBuyerTwoSellerNegotiation to negotiate sequentially with
two buyers and two sellers, where each buyer chooses one seller per round to negotiate with.
"""
...
def main(model_name=None):
    ...
    results = {
        "task": "Task3_sequential_two_buyer_two_seller_negotiation",
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task3: Sequential Two-Buyer Two-Seller Negotiation Results\n")
            f.write("="*80 + "\n\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task3: Sequential Two-Buyer Two-Seller Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
