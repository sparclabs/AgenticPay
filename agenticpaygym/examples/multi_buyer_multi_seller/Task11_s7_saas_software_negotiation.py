"""Task11 Scenario 7: SaaS Software - Sequential Two-Buyer Two-Seller Negotiation

Two buyers negotiating with two SaaS vendors for project management software.
...
def main(model_name=None):
    ...
    buyer1_max_price = 9500.0  # Maximum acceptable price for buyer1 (confidential) - small company
    buyer2_max_price = 10000.0  # Maximum acceptable price for buyer2 (confidential) - mid-size company
    seller1_min_price = 4800.0  # Minimum acceptable price for seller1 (confidential) - standard tier
    seller2_min_price = 5200.0  # Minimum acceptable price for seller2 (confidential) - enterprise tier
    ...
    env = Task3SequentialTwoBuyerTwoSellerNegotiation(
        ...
        initial_seller1_price=8400.0,  # Initial price offered by seller1
        initial_seller2_price=9000.0,  # Initial price offered by seller2 (higher for enterprise)
    ...
    user_profile = "Two IT managers competing for SaaS vendors. Buyer1 is small company seeking value. Buyer2 is mid-size company needing advanced features."
    print(f"User Profile: {user_profile}")
    
    # Get user requirement
    # Use default requirement for automatic running
    user_requirement = "Need project management tool for 50-person team with good support"
    ...
    observation, info = env.reset(
        ...
        product_info={
            ...
            "user_count": "50 users",
            "features_seller1": "Core features, email support",
            "features_seller2": "Advanced features, priority support, API access",
            "storage_seller1": "100GB",
            "storage_seller2": "Unlimited",
            "uptime_sla": "99.9%",
            "rating_seller1": "4.6/5",
            "rating_seller2": "4.8/5",
        },
    ...
    results = {
        "task": "Task11_s7_saas_software_negotiation",
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task11 Scenario 7: SaaS Software - Sequential Two-Buyer Two-Seller Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task11 Scenario 7: SaaS Software - Sequential Two-Buyer Two-Seller Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
