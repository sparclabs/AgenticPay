...
case "$TASK_NAME" in
    Task1|task1)
        TASK_SCRIPT="Task1_parallel_two_buyer_negotiation.py"
        TASK_DISPLAY="Task1"
        ;;
    Task2|task2)
        TASK_SCRIPT="Task2_parallel_three_buyer_negotiation.py"
        TASK_DISPLAY="Task2"
        ;;
    Task3|task3)
        TASK_SCRIPT="Task3_sequential_two_buyer_negotiation.py"
        TASK_DISPLAY="Task3"
        ;;
    Task4|task4)
        TASK_SCRIPT="Task4_sequential_three_buyer_negotiation.py"
        TASK_DISPLAY="Task4"
        ;;
    *)
