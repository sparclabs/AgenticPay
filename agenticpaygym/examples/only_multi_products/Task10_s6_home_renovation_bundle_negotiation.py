"""Task10 Scenario 6: Home Renovation Bundle - Two-Product Negotiation

Buyer negotiates for kitchen remodel with bathroom update bundle.
...
def main(model_name=None):
    ...
    buyer_max_price = 35000.0  # Maximum acceptable total purchase price for buyer (confidential) - Kitchen $25,000 + Bathroom $10,000
    seller_min_price = 22000.0  # Minimum acceptable total selling price for seller (confidential) - Kitchen $15,000 + Bathroom $7,000
    ...
    env = make(
        ...
        initial_seller_price=33000.0,  # Initial total price offered by seller for both services
    ...
    user_profile = "Homeowner planning major renovation. Budget-conscious but wants quality work. Very concerned about hidden costs, change orders, and timeline delays. Prefers fixed-price contracts with clear scope. Wants both projects done together for efficiency."
    ...
    product_info = {
        "products": [
            {
                "name": "Kitchen Remodel Package",
                "price": 24000.0,  # Individual price of first product
                "scope": ["Custom cabinets", "Granite countertops", "New appliances", "Tile backsplash", "Updated lighting"],
                "timeline": "5-6 weeks",
                "materials_grade": "Mid-range",
                "warranty": "1 year workmanship",
                "size": "12x15 ft kitchen",
            },
            {
                "name": "Master Bathroom Update Package",
                "price": 9000.0,  # Individual price of second product
                "scope": ["New vanity and fixtures", "Tile shower surround", "Updated lighting", "New flooring"],
                "timeline": "3-4 weeks",
                "materials_grade": "Mid-range",
                "warranty": "1 year workmanship",
                "size": "8x10 ft bathroom",
            },
        ]
    }
    ...
    user_requirement = "Need kitchen and bathroom renovation together. Want quality work within budget with no hidden costs."
    ...
    results = {
        "task": "Task10_s6_home_renovation_bundle_negotiation",
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task10 Scenario 6: Home Renovation Bundle - Two-Product Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task10 Scenario 6: Home Renovation Bundle - Two-Product Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
