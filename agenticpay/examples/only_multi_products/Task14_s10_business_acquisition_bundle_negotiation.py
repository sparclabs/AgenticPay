"""Task14 Scenario 10: Business Acquisition Bundle - Two-Product Negotiation

Buyer negotiates for small business acquisition with transition support bundle.
...
def main(model_name=None):
    ...
    buyer_max_price = 270000.0  # Maximum acceptable total purchase price for buyer (confidential) - Business $250,000 + Support $20,000
    seller_min_price = 210000.0  # Minimum acceptable total selling price for seller (confidential) - Business $195,000 + Support $15,000
    ...
    env = make(
        ...
        initial_seller_price=262000.0,  # Initial total price offered by seller for both
    ...
    user_profile = "Experienced entrepreneur seeking to acquire established business. Has financing pre-approved. Concerned about customer retention, staff turnover, and undisclosed liabilities. Values smooth transition and seller's cooperation during handover period. Risk-averse, needs detailed due diligence."
    ...
    product_info = {
        "products": [
            {
                "name": "Established E-commerce Business (Electronics Accessories)",
                "price": 245000.0,  # Individual price of first product
                "annual_revenue": "$480,000",
                "annual_profit": "$85,000 (verified)",
                "assets_included": ["Inventory ($45K)", "Website & domain", "Customer database (15K customers)", "Social media accounts"],
                "staff": "2 part-time employees",
                "lease": "No physical location (home-based)",
                "time_in_business": "15 years",
                "growth_potential": "High - can expand product line",
            },
            {
                "name": "6-Month Transition Support Package",
                "price": 17000.0,  # Individual price of second product
                "includes": ["Seller stays as consultant", "Supplier introductions", "Customer relationship handover", "Operations training", "Weekly calls for first 3 months"],
                "availability": "20 hours/month average",
                "non_compete": "3-year non-compete agreement included",
                "knowledge_transfer": "Access to all SOPs and business documentation",
            },
        ]
    }
    ...
    user_requirement = "Looking to acquire profitable e-commerce business with comprehensive transition support to ensure smooth handover."
    ...
    results = {
        "task": "Task14_s10_business_acquisition_bundle_negotiation",
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task14 Scenario 10: Business Acquisition Bundle - Two-Product Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task14 Scenario 10: Business Acquisition Bundle - Two-Product Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
