"""Task13 Scenario 9: Luxury Watch Bundle - Two-Product Negotiation

Buyer negotiates for luxury watch with extended warranty bundle.
...
def main(model_name=None):
    ...
    buyer_max_price = 9300.0  # Maximum acceptable total purchase price for buyer (confidential) - Watch $9,000 + Warranty $300
    seller_min_price = 6800.0  # Minimum acceptable total selling price for seller (confidential) - Watch $6,500 + Warranty $300
    ...
    env = make(
        ...
        initial_seller_price=8950.0,  # Initial total price offered by seller for both products
        ...
        environment_info={
            ...
            "market_demand": "High for this model",
        },
        price_tolerance=price_tolerance,
    )
    
    # Create user profile (text description of personal preferences)
    user_profile = "Watch collector and enthusiast. Knowledgeable about market prices and model variations. Values authenticity verification and full documentation. Interested in investment potential. Concerned about authenticity and after-sales service."
        ...
        "products": [
            {
                ...
                "price": 8600.0,  # Individual price of first product
                "model_year": 2022,
                "condition": "Excellent - Worn few times",
                "reference": "210.30.42.20.01.001",
                "original_price": 10500.0,
                "includes": ["Original box", "Papers", "Warranty card (18 months remaining)"],
                "authentication": "Verified by authorized service center",
            },
            {
                "name": "Extended Warranty Package (3 years)",
                "price": 350.0,  # Individual price of second product
                "coverage": "Full mechanical coverage + water resistance testing",
                "includes": ["Annual service", "Parts replacement", "Authenticity guarantee"],
                "transferable": "Yes, increases resale value",
                "provider": "Authorized Omega service center",
            },
        ]
    }
    ...
    user_requirement = "Looking for Omega Seamaster Professional 300M in excellent condition with extended warranty for investment and collecting."
    ...
    results = {
        "task": "Task13_s9_luxury_watch_bundle_negotiation",
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task13 Scenario 9: Luxury Watch Bundle - Two-Product Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task13 Scenario 9: Luxury Watch Bundle - Two-Product Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
