"""Task10 Scenario 6: Home Renovation Package - Sequential Two-Buyer Two-Product Negotiation

One seller negotiating with two buyers for home renovation package (core work + additional services).
Seller chooses one buyer per round to negotiate with.
Prices represent total price for the renovation package.
...
def main(model_name=None, difficulty="normal"):
    ...
    # buyer_max_price and seller_min_price represent total expected cost for home renovation package
    # Based on scenario 2-3: buyer_max_price=$35,000 (homeowner budget), seller_min_price=$22,000 (contractor cost)
    print("Creating agents...")
    buyer1_max_price = 35000.0  # Maximum acceptable total price for buyer1 (confidential, homeowner)
    buyer2_max_price = 40000.0  # Maximum acceptable total price for buyer2 (confidential, higher budget/quality focus)
    seller_min_price = 22000.0  # Minimum acceptable total price for seller (confidential, contractor cost)
    ...
    env = Task3SequentialTwoBuyerTwoProductNegotiation(
        ...
        initial_seller_price=33000.0,  # Initial total price offered by seller for renovation package
        ...
        environment_info={
            "property_type": "Single family home (1500 sq ft)",
    ...
    user_profile = "Two buyers competing for contractor. Buyer1 is budget-conscious homeowner. Buyer2 is willing to pay more for premium materials and extended warranty."
    print(f"User Profile: {user_profile}")
    
    # Define two products with their individual prices
    # The product_info should contain a list of two products (core work + additional services)
    product_info = {
        "products": [
            {
                "name": "Core Renovation Work",
                "brand": "Licensed Contractor",
                "price": 28000.0,  # Individual price of core work
                "scope": ["Kitchen remodel", "2 bathroom updates", "Flooring (1200 sq ft)", "Interior painting"],
                "timeline": "8-10 weeks",
                "materials_grade": "Mid-range",
                "contractor_rating": "4.5/5 (89 reviews)",
            },
            {
                "name": "Additional Services & Protections Package",
                "brand": "Contractor",
                "price": 5000.0,  # Individual price of additional services
                "services": ["Extended 2-year warranty", "Permits & inspections", "Cleanup & disposal"],
    ...
    user_requirement = "Complete renovation of 1500 sq ft home. Need quality work within reasonable budget. Very concerned about hidden costs."
    print(f"Using default requirement: {user_requirement}")
    
    # Reset environment
    print("\n" + "="*60)
    print("Starting new sequential negotiation for home renovation...")
    print("Seller choosing between two buyers for Full Home Renovation Package")
    print("="*60)
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task10 Scenario 6: Home Renovation Package - Sequential Two-Buyer Two-Product Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task10 Scenario 6: Home Renovation Package - Sequential Two-Buyer Two-Product Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
