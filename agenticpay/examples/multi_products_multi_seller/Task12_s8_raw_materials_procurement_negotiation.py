"""Task12 Scenario 8: Raw Materials Procurement - Sequential Two-Seller Per One Product Negotiation

Buyer negotiating with two suppliers offering different steel material packages.
...
def main(model_name=None):
    ...
    buyer_max_price = 85000.0  # Maximum acceptable price for buyer (confidential) - manufacturing company budget
    seller1_min_price = 62000.0  # Minimum acceptable price for seller1 (confidential) - domestic supplier
    seller2_min_price = 58000.0  # Minimum acceptable price for seller2 (confidential, lower due to international scale)
    ...
    env = Task3SequentialTwoSellerPerOneProductNegotiation(
        ...
        initial_seller1_price=78000.0,  # Initial price offered by seller1
        initial_seller2_price=72000.0,  # Initial price offered by seller2 (lower due to import advantage)
        ...
        environment_info={
            "market_type": "B2B commodity market",
    ...
    user_profile = "Procurement manager at manufacturing company. Needs reliable supply and competitive pricing. Values quality certifications, delivery reliability, and payment terms flexibility."
    print(f"User Profile: {user_profile}")
    
    # Get user requirement
    # Use default requirement for automatic running
    user_requirement = "Need 100 tons of Grade A steel plates for Q2 production. Require quality certification."
    print(f"Using default requirement: {user_requirement}")
    
    # Reset environment with different products for each seller
    print("\n" + "="*60)
    print("Starting new sequential negotiation with two suppliers (each with different steel material packages)...")
    print("="*60)
    
    observation, info = env.reset(
        user_requirement=user_requirement,
        seller1_product_info={
            "name": "Domestic Premium Steel Package",
            "supplier": "National Steel Co.",
            "quantity": "100 tons",
            "grade": "ASTM A36",
            "origin": "Domestic",
            ...
            "quality_guarantee": "Full refund for defects",
        },
        seller2_product_info={
            "name": "Import Cost-Effective Steel Package",
            "supplier": "Global Steel Trading",
            "quantity": "100 tons",
            "grade": "ASTM A36 equivalent",
            "origin": "Import (Asia)",
            "delivery_time": "6-8 weeks",
            "payment_terms": "Net 60",
            "certifications": ["ISO 9001"],
            "quality_guarantee": "Replacement for major defects",
        },
    ...
    results = {
        "task": "Task12_s8_raw_materials_procurement_negotiation",
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task12 Scenario 8: Raw Materials Procurement - Sequential Two-Seller Per One Product Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task12 Scenario 8: Raw Materials Procurement - Sequential Two-Seller Per One Product Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
