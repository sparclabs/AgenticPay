"""Task14 Scenario 10: Business Acquisition - Sequential Two-Seller Negotiation

Two business owners offering profitable e-commerce businesses on Acquire.com platform.
Buyer compares financials, traffic sources, and asking prices, choosing which seller to negotiate with each round.
...
def main(model_name=None):
    ...
    buyer_max_price = 120000.0  # Maximum acceptable purchase price for buyer (confidential) - 3x annual profit
    seller1_min_price = 80000.0  # Minimum acceptable selling price for seller1 (confidential) - 2x annual profit + psychological price
    seller2_min_price = 85000.0  # Minimum acceptable selling price for seller2 (confidential, better traffic diversification)
    ...
    env = Task3SequentialTwoSellerNegotiation(
        ...
        initial_seller1_price=115000.0,  # Initial price offered by seller1
        initial_seller2_price=125000.0,  # Initial price offered by seller2 (higher, better traffic mix)
        ...
        environment_info={
            ...
            "competing_buyers": 3,
            "seller1_time_on_market": "2 weeks",
            "seller2_time_on_market": "1 week",
            "seller1_verified": True,
            "seller2_verified": True,
            "financials_verified_by_platform": True,
        },
    ...
    user_profile = "Serial entrepreneur looking to acquire established online business. Values diversified traffic sources and proven business model. Concerned about revenue sustainability and smooth transition. Experienced in due diligence."
    ...
    observation, info = env.reset(
        ...
        product_info={
            ...
            "seller1_traffic_organic": "55%",
            "seller1_traffic_paid": "35%",
            "seller1_traffic_social": "10%",
            "seller2_traffic_organic": "60%",
            "seller2_traffic_paid": "30%",
            "seller2_traffic_social": "10%",
            ...
            "seller1_reason": "Owner pursuing other ventures",
            "seller2_reason": "Relocating internationally",
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task14 Scenario 10: Business Acquisition - Sequential Two-Seller Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task14 Scenario 10: Business Acquisition - Sequential Two-Seller Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
