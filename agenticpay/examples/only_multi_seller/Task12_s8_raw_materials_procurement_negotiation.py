"""Task12 Scenario 8: Raw Materials Procurement - Sequential Two-Seller Negotiation

Two suppliers offering ceramic capacitors for electronics manufacturing.
Buyer compares quality certifications and pricing, choosing which supplier to negotiate with each round.
...
def main(model_name=None, difficulty="normal"):
    ...
    buyer_max_price = 4500.0  # Maximum acceptable purchase price for buyer (confidential) - $0.45/unit × 10,000 units
    seller1_min_price = 3200.0  # Minimum acceptable selling price for seller1 (confidential) - $0.32/unit × 10,000 units
    seller2_min_price = 3400.0  # Minimum acceptable selling price for seller2 (confidential, higher quality certification)
    ...
    env = Task3SequentialTwoSellerNegotiation(
        ...
        initial_seller1_price=4200.0,  # Initial price offered by seller1 (10,000 units)
        initial_seller2_price=4400.0,  # Initial price offered by seller2 (higher, better quality)
        ...
        environment_info={
            ...
            "seller1_lead_time": "2-3 weeks",
            "seller2_lead_time": "3-4 weeks",
            "seller1_capacity": "500,000 units/month",
            "seller2_capacity": "300,000 units/month",
        },
    ...
    observation, info = env.reset(
        ...
        product_info={
            ...
            "seller1_quality_certification": ["ISO 9001", "AEC-Q200"],
            "seller2_quality_certification": ["ISO 9001", "AEC-Q200", "IATF 16949"],
            "seller1_defect_rate": "< 0.1%",
            "seller2_defect_rate": "< 0.05%",
        },
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task12 Scenario 8: Raw Materials Procurement - Sequential Two-Seller Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task12 Scenario 8: Raw Materials Procurement - Sequential Two-Seller Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
