"""Task13 Scenario 9: Luxury Watch - Sequential Two-Seller Negotiation

Two private sellers offering pre-owned Rolex Submariner on Chrono24 platform.
Buyer compares condition, authenticity, and pricing, choosing which seller to negotiate with each round.
...
def main(model_name=None):
    ...
    seller1_min_price = 7000.0  # Minimum acceptable selling price for seller1 (confidential)
    seller2_min_price = 7500.0  # Minimum acceptable selling price for seller2 (confidential, better condition)
    ...
    env = Task3SequentialTwoSellerNegotiation(
        ...
        initial_seller1_price=9200.0,  # Initial price offered by seller1
        initial_seller2_price=9800.0,  # Initial price offered by seller2 (higher, better condition)
        ...
        environment_info={
            ...
            "seller1_rating": "4.7/5 (18 transactions)",
            "seller2_rating": "4.9/5 (31 transactions)",
            "seller1_type": "Private collector",
            "seller2_type": "Authorized dealer",
        },
    ...
    user_profile = "Watch enthusiast and collector looking for investment piece. Authenticity is top priority, also values full documentation and service history. Willing to pay premium for perfect condition."
    ...
    observation, info = env.reset(
        ...
        product_info={
            ...
            "seller1_condition": "Excellent, minor desk diving marks",
            "seller2_condition": "Near mint, barely worn",
            "seller1_box_papers": "Full set with warranty card",
            "seller2_box_papers": "Complete set with all documentation",
            "seller1_service_history": "Serviced by Rolex in 2023",
            "seller2_service_history": "Never serviced, barely worn",
            "authentication": "Both offer third-party verification",
        },
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task13 Scenario 9: Luxury Watch - Sequential Two-Seller Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task13 Scenario 9: Luxury Watch - Sequential Two-Seller Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
