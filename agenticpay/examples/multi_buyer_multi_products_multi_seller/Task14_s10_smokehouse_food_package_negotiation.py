...
def main(model_name=None):
    ...
    buyer1_max_price = 70.0  # Maximum acceptable total price for buyer1 (confidential)
    buyer2_max_price = 75.0  # Maximum acceptable total price for buyer2 (confidential)
