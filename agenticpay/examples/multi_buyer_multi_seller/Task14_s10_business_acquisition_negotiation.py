"""Task14 Scenario 10: Business Acquisition - Sequential Two-Buyer Two-Seller Negotiation

Two buyers negotiating with two business brokers for small businesses.
...
def main(model_name=None):
    ...
    buyer1_max_price = 520000.0  # Maximum acceptable price for buyer1 (confidential) - serial entrepreneur
    buyer2_max_price = 550000.0  # Maximum acceptable price for buyer2 (confidential) - investment firm
    seller1_min_price = 380000.0  # Minimum acceptable price for seller1 (confidential) - coffee shop owner
    seller2_min_price = 360000.0  # Minimum acceptable price for seller2 (confidential) - agency founder
    ...
    env = Task3SequentialTwoBuyerTwoSellerNegotiation(
        ...
        initial_seller2_price=450000.0,  # Initial price offered by seller2 (lower for agency)
    ...
    user_profile = "Two buyers competing for small businesses. Buyer1 is serial entrepreneur. Buyer2 is investment firm with more capital."
    print(f"User Profile: {user_profile}")
    
    # Get user requirement
    # Use default requirement for automatic running
    user_requirement = "Looking for profitable small business with steady cash flow"
    ...
    observation, info = env.reset(
        ...
        product_info={
            "name": "Small Business Acquisition",
            "business1_type": "Local Coffee Shop",
            "business2_type": "Digital Marketing Agency",
            "revenue_seller1": "$420,000/year",
            "revenue_seller2": "$380,000/year",
            "profit_seller1": "$95,000/year",
            "profit_seller2": "$88,000/year",
            "years_seller1": "8 years operating",
            "years_seller2": "4 years operating",
            "financing_seller1": "50% owner financing",
            "financing_seller2": "30% owner financing",
        },
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task14 Scenario 10: Business Acquisition - Sequential Two-Buyer Two-Seller Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task14 Scenario 10: Business Acquisition - Sequential Two-Buyer Two-Seller Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
