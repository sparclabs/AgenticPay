"""Task12 Scenario 8: Raw Materials Procurement - Sequential Two-Buyer Two-Seller Negotiation

Two buyers negotiating with two suppliers for steel materials.
...
def main(model_name=None):
    ...
    buyer1_max_price = 85000.0  # Maximum acceptable price for buyer1 (confidential) - manufacturing company
    buyer2_max_price = 90000.0  # Maximum acceptable price for buyer2 (confidential) - large construction firm
    seller1_min_price = 62000.0  # Minimum acceptable price for seller1 (confidential) - domestic supplier
    seller2_min_price = 58000.0  # Minimum acceptable price for seller2 (confidential) - import supplier
    ...
    env = Task3SequentialTwoBuyerTwoSellerNegotiation(
        ...
        initial_seller2_price=72000.0,  # Initial price offered by seller2 (lower for import)
    ...
    user_profile = "Two procurement managers competing for steel suppliers. Buyer1 is manufacturing company valuing quality. Buyer2 is construction firm prioritizing cost."
    print(f"User Profile: {user_profile}")
    
    # Get user requirement
    # Use default requirement for automatic running
    user_requirement = "Need 100 tons of Grade A steel plates for Q2 production"
    ...
    observation, info = env.reset(
        ...
        product_info={
            "name": "Steel Plates Procurement",
            "quantity": "100 tons",
            "grade": "ASTM A36",
            "origin_seller1": "Domestic",
            "origin_seller2": "Import (Asia)",
            "delivery_seller1": "3 weeks",
            "delivery_seller2": "6-8 weeks",
            "payment_seller1": "Net 30",
            "payment_seller2": "Net 60",
            "certifications_seller1": "ISO 9001, ASTM",
            "certifications_seller2": "ISO 9001",
        },
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task12 Scenario 8: Raw Materials Procurement - Sequential Two-Buyer Two-Seller Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task12 Scenario 8: Raw Materials Procurement - Sequential Two-Buyer Two-Seller Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
