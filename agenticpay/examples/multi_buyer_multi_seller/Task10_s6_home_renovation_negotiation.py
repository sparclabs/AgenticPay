"""Task10 Scenario 6: Home Renovation - Sequential Two-Buyer Two-Seller Negotiation

Two buyers negotiating with two contractors for kitchen renovation services.
...
def main(model_name=None):
    ...
    buyer1_max_price = 25000.0  # Maximum acceptable price for buyer1 (confidential) - budget-conscious homeowner
    buyer2_max_price = 27000.0  # Maximum acceptable price for buyer2 (confidential) - quality-focused homeowner
    seller1_min_price = 15000.0  # Minimum acceptable price for seller1 (confidential) - standard contractor
    seller2_min_price = 16000.0  # Minimum acceptable price for seller2 (confidential) - premium contractor
    ...
    env = Task3SequentialTwoBuyerTwoSellerNegotiation(
        ...
        initial_seller1_price=24000.0,  # Initial price offered by seller1
        initial_seller2_price=27000.0,  # Initial price offered by seller2 (higher for premium)
    ...
    user_profile = "Two homeowners competing for contractors. Buyer1 is budget-conscious. Buyer2 prioritizes quality and faster completion."
    print(f"User Profile: {user_profile}")
    
    # Get user requirement
    # Use default requirement for automatic running
    user_requirement = "Need kitchen remodel with new cabinets and countertops"
    ...
    observation, info = env.reset(
        ...
        product_info={
            ...
            "scope_seller1": "Standard cabinets, granite countertop",
            "scope_seller2": "Custom cabinets, quartz countertop",
            "timeline_seller1": "6-8 weeks",
            "timeline_seller2": "4-6 weeks",
            "warranty_seller1": "1 year",
            "warranty_seller2": "2 years",
            "rating_seller1": "4.7/5 (145 reviews)",
            "rating_seller2": "4.9/5 (203 reviews)",
        },
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task10 Scenario 6: Home Renovation - Sequential Two-Buyer Two-Seller Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task10 Scenario 6: Home Renovation - Sequential Two-Buyer Two-Seller Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
