"""Task12 Scenario 8: Raw Materials Procurement - Sequential Two-Buyer Negotiation

One supplier negotiating with two potential manufacturing clients for steel coils.
...
def main(model_name=None, difficulty="normal"):
    ...
    buyer1_max_price = 210000.0  # Maximum acceptable price for buyer1 (confidential) - manufacturing company budget
    buyer2_max_price = 205000.0  # Maximum acceptable price for buyer2 (confidential, different from buyer1)
    seller_min_price = 160000.0  # Minimum acceptable price for seller (confidential) - covers material and shipping costs
    ...
    env = Task3SequentialTwoBuyerNegotiation(
        ...
        initial_seller_price=195000.0,  # Initial price offered by seller
    ...
    user_profile = "Supply chain manager for manufacturing company. Experienced in bulk purchasing and contract negotiations. Needs to balance price, delivery timeline, and quality consistency. Has existing supplier relationships. Production schedule is tight."
    print(f"User Profile: {user_profile}")
    
    # Get user requirement
    # Use default requirement for automatic running
    user_requirement = "Need 50 tons of cold-rolled steel with timely delivery. Our production schedule requires materials within reasonable timeframe."
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task12 Scenario 8: Raw Materials Procurement - Sequential Two-Buyer Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task12 Scenario 8: Raw Materials Procurement - Sequential Two-Buyer Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
