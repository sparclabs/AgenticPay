"""Task11 Scenario 7: SaaS Software - Sequential Two-Buyer Negotiation

One SaaS vendor negotiating with two potential corporate clients for annual subscription.
...
def main(model_name=None, difficulty="normal"):
    ...
    buyer1_max_price = 9500.0  # Maximum acceptable annual price for buyer1 (confidential) - IT budget
    buyer2_max_price = 9000.0  # Maximum acceptable annual price for buyer2 (confidential, different from buyer1)
    seller_min_price = 4800.0  # Minimum acceptable annual price for seller (confidential) - covers costs
    ...
    env = Task3SequentialTwoBuyerNegotiation(
        ...
        initial_seller_price=8400.0,  # Initial annual price offered by seller ($14/seat/month × 50 seats × 12 months)
    ...
    user_requirement = "Need project management tool for 50-person team. Looking for annual subscription with good support."
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task11 Scenario 7: SaaS Software - Sequential Two-Buyer Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task11 Scenario 7: SaaS Software - Sequential Two-Buyer Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
