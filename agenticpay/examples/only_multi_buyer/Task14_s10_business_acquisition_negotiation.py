"""Task14 Scenario 10: Business Acquisition - Sequential Two-Buyer Negotiation

One business owner negotiating with two potential buyers for established e-commerce business.
...
def main(model_name=None, difficulty="normal"):
    ...
    buyer1_max_price = 270000.0  # Maximum acceptable price for buyer1 (confidential) - entrepreneur with financing
    buyer2_max_price = 260000.0  # Maximum acceptable price for buyer2 (confidential, different from buyer1)
    seller_min_price = 195000.0  # Minimum acceptable price for seller (confidential) - business valuation floor
    ...
    env = Task3SequentialTwoBuyerNegotiation(
        ...
        initial_seller_price=245000.0,  # Initial price offered by seller
    ...
    user_profile = "Experienced entrepreneur seeking to acquire established business. Has financing pre-approved. Concerned about customer retention, staff turnover, and undisclosed liabilities. Values smooth transition and seller's cooperation during handover period."
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task14 Scenario 10: Business Acquisition - Sequential Two-Buyer Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task14 Scenario 10: Business Acquisition - Sequential Two-Buyer Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
