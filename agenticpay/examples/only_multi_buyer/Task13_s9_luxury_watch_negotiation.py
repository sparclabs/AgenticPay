"""Task13 Scenario 9: Luxury Watch - Sequential Two-Buyer Negotiation

One watch dealer negotiating with two potential collectors for luxury Omega watch.
...
def main(model_name=None, difficulty="normal"):
    ...
    buyer1_max_price = 9300.0  # Maximum acceptable price for buyer1 (confidential) - collector budget
    buyer2_max_price = 9000.0  # Maximum acceptable price for buyer2 (confidential, different from buyer1)
    seller_min_price = 6500.0  # Minimum acceptable price for seller (confidential) - dealer acquisition cost + minimum margin
    ...
    env = Task3SequentialTwoBuyerNegotiation(
        ...
        initial_seller_price=8600.0,  # Initial price offered by seller
    ...
    user_requirement = "Looking for Omega Seamaster Professional 300M in excellent condition for investment and collecting."
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task13 Scenario 9: Luxury Watch - Sequential Two-Buyer Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task13 Scenario 9: Luxury Watch - Sequential Two-Buyer Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
