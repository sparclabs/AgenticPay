"""Task9 Scenario 5: Commercial Photography - Sequential Two-Buyer Negotiation

One photographer negotiating with two potential clients for product photography service.
...
def main(model_name=None, difficulty="normal"):
    ...
    buyer1_max_price = 2000.0  # Maximum acceptable price for buyer1 (confidential) - e-commerce seller budget
    buyer2_max_price = 1800.0  # Maximum acceptable price for buyer2 (confidential, different from buyer1)
    seller_min_price = 800.0  # Minimum acceptable price for seller (confidential) - covers equipment and time
    ...
    env = Task3SequentialTwoBuyerNegotiation(
        ...
        initial_seller_price=1500.0,  # Initial price offered by seller
    ...
    observation, info = env.reset(
        ...
        product_info={
            ...
            "portfolio": "Specialized in e-commerce and product photography",
        },
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task9 Scenario 5: Commercial Photography - Sequential Two-Buyer Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task9 Scenario 5: Commercial Photography - Sequential Two-Buyer Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
