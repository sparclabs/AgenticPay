...
def main(model_name=None, difficulty="normal"):
    ...
    buyer3_max_price, _ = adjust_zopa(buyer3_max_price, seller_min_price, difficulty)
    ...
    results = {
        ...
        "task": "Task4_sequential_three_buyer_negotiation",
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task4: Sequential Three-Buyer Negotiation Results\n")
            f.write("="*80 + "\n\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task4: Sequential Three-Buyer Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
