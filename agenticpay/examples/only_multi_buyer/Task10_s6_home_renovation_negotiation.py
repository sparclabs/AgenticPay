"""Task10 Scenario 6: Home Renovation - Sequential Two-Buyer Negotiation

One contractor negotiating with two potential clients for kitchen remodel project.
...
def main(model_name=None, difficulty="normal"):
    ...
    buyer1_max_price = 25000.0  # Maximum acceptable price for buyer1 (confidential) - homeowner budget
    buyer2_max_price = 23000.0  # Maximum acceptable price for buyer2 (confidential, different from buyer1)
    seller_min_price = 15000.0  # Minimum acceptable price for seller (confidential) - covers materials and labor
    ...
    env = Task3SequentialTwoBuyerNegotiation(
        ...
        initial_seller_price=24000.0,  # Initial price offered by seller
    ...
    user_profile = "Homeowner planning kitchen renovation. Budget-conscious but wants quality work. Very concerned about hidden costs, change orders, and timeline delays. Prefers fixed-price contracts with clear scope."
    print(f"User Profile: {user_profile}")
    
    # Get user requirement
    # Use default requirement for automatic running
    user_requirement = "Need kitchen remodel with new cabinets and countertops. Want quality work within budget with no hidden costs."
    ...
    observation, info = env.reset(
        ...
        product_info={
            ...
            "contractor_license": "Licensed and insured",
        },
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write("="*80 + "\n")
            f.write("Task10 Scenario 6: Home Renovation - Sequential Two-Buyer Negotiation Results\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task10 Scenario 6: Home Renovation - Sequential Two-Buyer Negotiation")
    parser.add_argument(
        "--model",
        type=str,
        default=None,
